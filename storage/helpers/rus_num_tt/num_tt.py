...
def add_plus_and_textnum(fname):
    lst1 = []
    lst2 = []
    dump_strfile_in_lst('helpers/rus_num_tt/word.txt', lst1)
    dump_strfile_in_lst('helpers/rus_num_tt/word+.txt', lst2)               
...
for i in range(5, 6):
    add_plus_and_textnum(f'helpers/rus_num_tt/merge/merge_{i}ch.txt')                   